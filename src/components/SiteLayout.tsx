  ...
  return (
    <div className="site-shell">
      ...
      <SocialLinks storefront={storefront} placement="rail" /><footer className="site-footer" id="footer">
        ...
        <div><p className="footer-label">{content.footer.policiesLabel}</p><a href="/privacy" onClick={navigate('/privacy')}>{content.footer.privacyLabel}</a><a href="/returns" onClick={navigate('/returns')}>{content.footer.returnsLabel}</a><a href="/refund-policy" onClick={navigate('/refund-policy')}>Refund Policy</a><a href="/terms" onClick={navigate('/terms')}>Terms &amp; Conditions</a></div>
