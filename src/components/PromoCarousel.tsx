...
export function PromoCarousel({
  ...
  return (
    ...
    >
      <div className={`promo-art promo-art-${promo.artwork}`} aria-hidden="true">
        <span>FEATURED / {String(active + 1).padStart(2, '0')}</span>
      </div>
      <div className="promo-copy">
        ...
        <div className="promo-actions">
          ...
          <span className="promo-count" aria-live="polite">
