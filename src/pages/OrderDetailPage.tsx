      ...
      <div className="order-detail-grid">
        <div className="order-detail-main">
          <div className="order-detail-status">
            ...
            <p>Delivered on Aug 22, 2026</p>
          </div>
          <h2>Items in this order</h2>
          {items.map((item) => (
            <div className="detail-item" key={item.id}>
              <div className="order-product-art product-art tone-sage">
        ...
        <aside className="order-detail-aside">
          ...
          <p className="eyebrow detail-label">DELIVERED TO</p>
          <p className="detail-muted">
            Your saved delivery address
            <br />
            India
          </p>
          <p className="eyebrow detail-label">PAYMENT</p>
          <p className="detail-muted">Razorpay · Paid</p>
          <a className="primary-button" href={trackingPath} onClick={onNavigate(trackingPath)}>
            Track this order →
          </a>
        </aside>
      </div>
